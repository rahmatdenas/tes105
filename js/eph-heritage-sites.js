       ...
       if (indexList) {         
         indexList.innerHTML = `
           <div style="padding: 40px 20px; text-align: center; line-height: 1.6;">
             ...
             <a href="#" onclick="window.location.href = window.location.pathname; return false;" style="background-color: #882222; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: 600; display: inline-block;">Kembali</a>
           </div>
         `;
       }
